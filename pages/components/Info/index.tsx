  ...
  return (
    <section className="p-4 bg-slate-800">
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-center text-white text-4xl font-bold p-6">
          Suplemento inteligente
        </h1>
        <div className="max-w-[1440px] flex flex-col justify-center items-center">
          <h2 className="text-gray-400 text-lg w-1/2 text-center leading-relaxed">
      ...
      <div>
        <div className="flex flex-col items-center justify-center pb-6">
          <h3 className="text-green-500 font-semibold text-5xl pt-7 pb-2">
            + 1000
          </h3>
          <h5 className="text-gray-300 font-semibold text-lg">
