...
export default function Hero() {
  return (
    <div className="bg-no-repeat bg-hero-pattern bg-cover bg-center">
      <section className="
        pt-14 justify-start items-center flex flex-col backdrop-blur-md"
      >
        <div className="max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            />
            <div className="items-center justify-between flex flex-col px-3 
              pb-10"
              >
              <p className="text-gray-300 text-xl leading-relaxed p-3 mb-3 max-w-xl 
                font-sans sm:pr-6"
              >
